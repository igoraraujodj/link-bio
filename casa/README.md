...
Abre em `casa/index.html`. Não precisa instalar nada, não tem build, não tem
dependência. É HTML, CSS e JavaScript com módulos nativos.
...
## Mover pra um repositório próprio

Esta pasta não depende de nada do portfólio: nenhum import, nenhum estilo,
